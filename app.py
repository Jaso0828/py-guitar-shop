from core import (Guitar, 
                ...
                GuitarString,
                StringType)
from services import GuitarServices
...
def main():
    ...
    fender_amp = Amplifier(name="Fender Twin Reverb", amp_type=amp_type, power=60)
    ...
    guitar_string = GuitarString(name="Ernie Ball Regular Slinky", gauge=0.010, type=string_type)
